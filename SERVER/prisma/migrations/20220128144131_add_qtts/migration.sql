/*
  ...
  - Added the required column `qtt_notes` to the `operations` table without a default value. This is not possible if the table is not empty.
  - Added the required column `qtt_packages` to the `operations` table without a default value. This is not possible if the table is not empty.
